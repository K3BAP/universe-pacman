class Ghost {
  ...
  setSpriteSheet(name, direction, mode) {
    ...
    if (mode === 'scared') {
      this.animationTarget.style.backgroundImage = 'url(../public/games/pacman/app/style/graphics/'
...
class Pacman {
  ...
  reset() {
    ...
    this.pacmanArrow.style.backgroundImage = 'url(../public/games/pacman/app/style/graphics/'
  ...
  prepDeathAnimation() {
    ...
    this.animationTarget.style.backgroundSize = `${bgSize}px`;
    this.animationTarget.style.backgroundImage = 'url(../public/games/pacman/app/style/'
...
class GameCoordinator {
  constructor() {
    ...
    link.rel = 'stylesheet';
    link.href = '../public/games/pacman/build/app.css';
  ...
  submitHighscore(highscore) {
    // 3 is the game id for pacman!
    fetch(BASE_URL + 'leaderboard/submitHighscore/3/' + highscore, {
      method: 'POST',
      headers: {
  ...
  getHighscore() {
    return fetch(BASE_URL + 'leaderboard/getPersonalHighscore/3', {
      method: 'GET',
      headers: {
        'Content-Type': 'application/json'
      }
  ...
  updateHighestLeaderbordScore() {
    return fetch(BASE_URL + 'leaderboard/highscore/3', {
      method: 'GET',
      headers: {
        'Content-Type': 'application/json'
      }
  ...
  preloadAssets() {
    return new Promise((resolve) => {
      ...
      const imgBase = '../public/games/pacman/app/style/graphics/spriteSheets/';
      const imgSources = [
        // Pacman
        ...
        // Misc
        '../public/games/pacman/app/style/graphics/extra_life.png',
      ];

      const audioBase = '../public/games/pacman/app/style/audio/';
      const audioSources = [
  ...
  updateExtraLivesDisplay() {
    ...
    for (let i = 0; i < this.lives; i += 1) {
      ...
      extraLifePic.setAttribute('src', '../public/games/pacman/app/style/graphics/extra_life.svg');
  ...
  advanceLevel() {
    ...
    const imgBase = '../public/games/pacman/app/style//graphics/spriteSheets/maze/';
  ...
  displayText(position, amount, duration, width, height) {
    ...
    pointsDiv.style.backgroundImage = 'url(../public/games/pacman/app/style/graphics/'
...
class Pickup {
  ...
  determineImage(type, points) {
    ...
    return `url(../public/games/pacman/app/style/graphics/spriteSheets/pickups/${image}.svg)`;
  }
...
class SoundManager {
  constructor() {
    this.baseUrl = '../public/games/pacman/app/style/audio/';
    this.fileFormat = 'mp3';
    this.masterVolume = 1;
    this.paused = false;
    this.cutscene = true;

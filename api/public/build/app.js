class Ghost {
  ...
  setSpriteSheet(name, direction, mode) {
    ...
    if (mode === 'scared') {
      this.animationTarget.style.backgroundImage = 'url(public/app/style/graphics/'
...
class Pacman {
  ...
  reset() {
    ...
    this.pacmanArrow.style.backgroundImage = 'url(public/app/style/graphics/'
  ...
  prepDeathAnimation() {
    ...
    this.animationTarget.style.backgroundSize = `${bgSize}px`;
    this.animationTarget.style.backgroundImage = 'url(public/app/style/'
...
class GameCoordinator {
  ...
  preloadAssets() {
    return new Promise((resolve) => {
      ...
      const imgBase = 'public/app/style/graphics/spriteSheets/';
      const imgSources = [
        // Pacman
        ...
        // Misc
        'public/app/style/graphics/extra_life.png',
      ];

      const audioBase = 'public/app/style/audio/';
      const audioSources = [
  ...
  updateExtraLivesDisplay() {
    ...
    for (let i = 0; i < this.lives; i += 1) {
      ...
      extraLifePic.setAttribute('src', 'public/app/style/graphics/extra_life.svg');
  ...
  advanceLevel() {
    ...
    const imgBase = 'public/app/style//graphics/spriteSheets/maze/';
  ...
  displayText(position, amount, duration, width, height) {
    ...
    pointsDiv.style.backgroundImage = 'url(public/app/style/graphics/'
...
class Pickup {
  ...
  determineImage(type, points) {
    ...
    return `url(public/app/style/graphics/spriteSheets/pickups/${image}.svg)`;
  }
...
class SoundManager {
  constructor() {
    this.baseUrl = 'public/app/style/audio/';
    this.fileFormat = 'mp3';
    this.masterVolume = 1;
    this.paused = false;
    this.cutscene = true;

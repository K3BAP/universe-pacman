...
<html>
  ...
  <body>
    <div id='overflow-mask' class='overflow-mask'>
      <img id='backdrop' class='backdrop' src='<?= base_url() ?>public/games/pacman/app/style/graphics/backdrop.png'>

      <div id='fps-display' class='fps-display'></div>
      <div id='preload-div' class='preload-div'></div>

      <div id='main-menu-container' class='main-menu-container'>
        <img id='logo' class='logo' src='<?= base_url() ?>public/games/pacman/app/style/graphics/pacman_logo.png'>
      ...
      <div id='game-ui' class='game-ui'>
        ...
        <div id='maze' class='maze'>
          <img id='maze-img' class='maze-img' src='<?= base_url() ?>public/games/pacman/app/style/graphics/spriteSheets/maze/maze_blue.svg'>

<head>
    ...
    <link href="<?php echo base_url();?>public/resources/css/main.css" rel="stylesheet" type="text/css">
    <link href="<?php echo base_url();?>public/resources/css/custom.css" rel="stylesheet" type="text/css">
    ...
    <script>
        const BASE_URL = "<?= base_url() ?>public/"; // Set baseURL for all scripts
    </script>
